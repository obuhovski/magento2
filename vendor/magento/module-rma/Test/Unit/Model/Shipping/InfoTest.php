...
class InfoTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->rmaDataMock = $this->getMock('Magento\Rma\Helper\Data', [], [], '', false);
        $this->rmaFactoryMock = $this->getMock('Magento\Rma\Model\RmaFactory', ['create'], [], '', false);
        $this->shippingFactoryMock = $this->getMock('Magento\Rma\Model\ShippingFactory', ['create'], [], '', false);
        $this->model = $this->objectManagerHelper->getObject(
            'Magento\Rma\Model\Shipping\Info',
            [
    ...
    public function testGetTrackingInfoByRma()
    {
        $rmaId = '123';
    ...
    public function testGetTrackingInfoByTrackId()
    {
        $trackId = '123';
        $protectedCode = '0e015339760548602306096794382326';
        $maliciousProtectedCode = '0';
